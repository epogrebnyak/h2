...
экономики водородного цикла. Это то, что можно подчерпнуть про водород из уже имеющейся информации.
...
Вопросы, по которым сохраняется наибольшая неопределенность и акутальны новые исследования представлены в [отдельном разделе](#misc).
